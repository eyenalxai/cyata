...
export const selectUserPreferences = (tx: Transaction, userUuid: string) =>
...
export const insertUserPreferences = (tx: Transaction, preferences: UserPreferencesInsert) =>
...
export const updateDefaultModel = (tx: Transaction, { userUuid, defaultModel }: UpdateDefaultModelProps) =>
...
export const updateSystemPrompt = (tx: Transaction, { userUuid, systemPrompt }: UpdateSystemPromptProps) =>
	ResultAsync.fromPromise(
